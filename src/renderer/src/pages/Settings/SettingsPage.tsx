...
function SettingsPage(): React.JSX.Element {
  ...
  // Resolve the on-disk config file path (from the main process).
  useEffect(() => {
  ...
  return (
    <div className="h-full overflow-y-auto p-4">
      <Card className="mx-auto max-w-xl">
        <CardHeader>
          <CardTitle>SIP settings</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-xs text-muted-foreground">
              Domain used in REGISTER/INVITE request-URIs (sip:user@domain). Leave blank to use the
              wss endpoint host.
            </p>
          </div>
